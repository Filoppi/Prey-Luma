...
Copy-Item '../../build/Release/*' './' -Force -Recurse -ErrorAction:SilentlyContinue
...
Compress-Archive -Path './*.dll','./*.ini','./*.json','./*.toml' -DestinationPath './Prey-Luma-Native.v1.0.0.zip' -Force -ErrorAction:SilentlyContinue
