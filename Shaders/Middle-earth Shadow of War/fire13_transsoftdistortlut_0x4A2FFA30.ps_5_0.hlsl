// ---- Created with 3Dmigoto v1.3.16 on Thu Jul 16 19:31:23 2026
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.x = v3.w + -r0.x;
  r0.x = saturate(abs(r0.x) / cb3[4].y);
  r0.x = 1 + -r0.x;
  r0.x = log2(r0.x);
  r0.x = cb3[4].z * r0.x;
  r0.x = exp2(r0.x);
  r0.x = 1 + -r0.x;
  r0.yz = v1.xy * cb3[2].zw + cb3[3].xy;
  r0.yz = cb1[1].xx * cb3[3].zw + r0.yz;
  r0.yz = t0.Sample(s0_s, r0.yz).yw;
  r1.xy = r0.yz * float2(2,2) + float2(-1,-1);
  r1.z = -r1.y;
  r0.yz = r1.xz * cb3[4].xx + v1.xy;
  ...
  r0.yzw = t3.SampleLevel(s3_s, r1.xyz, 0).xyz;
    r0.xyz *= FIRE_BOOST * 0.6;
  r0.yzw = cb3[0].xyz * r0.yzw;
  r0.yzw = r0.yzw * r0.xxx;
  o0.w = r0.x;
  r0.x = !cb3[2].y ? cb2[24].w : 1;
