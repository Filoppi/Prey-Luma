  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.xyzw = -r1.wxyz + r0.wxyz;
  r0.xyzw = r1.wwww * r0.xyzw + r1.wxyz;
  r1.xyzw = Texture0.Sample(TexS0_s, v3.xy).xyzw;
  r0.xyzw = r1.wxyz * r0.xyzw;
  r0.yzw = /* saturate */(r0.yzw + r0.yzw); r0.yzw = max(r0.yzw, 0);
  r1.xyzw = Texture3.Sample(TexS3_s, v6.xy).xyzw;
  r0.yzw = r1.xyz * r0.yzw;
  o0.w = r1.w * r0.x; o0.w = saturate(o0.w);
  o0.xyz = /* saturate */(r0.yzw + r0.yzw); o0.xyz = max(o0.xyz, 0);
  return;
}