// ---- Created with 3Dmigoto v1.3.16 on Tue Aug 04 16:25:22 2026
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r2.yzw = Texture1.Sample(TexSampler1_s, v4.xy).xyz;
  r2.yzw = float3(-0.5,-0.5,-0.5) + r2.yzw;
  r2.yzw = r2.xxx * r2.yzw + float3(0.5,0.5,0.5);
  r1.w = v2.w * r2.x;
  r0.xyz = r2.yzw * float3(2,2,2) + r0.xyz;
  o0.w = r0.w;
