// ---- Created with 3Dmigoto v1.3.16 on Tue Aug 04 16:25:34 2026
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.xzw = max(0, r0.xxx * c_self_illumination_color.xyz + v1.xyz);
  o0.w = r0.y;
  ...
  r0.xyz = max(0, r2.xyz * r0.xyz + r1.xyz);
  r1.xyz = c_fog_color.xyz + -r0.xyz;
  o0.xyz = v1.www * r1.xyz + r0.xyz;
