// ---- Created with 3Dmigoto v1.3.16 on Tue Aug 04 16:23:12 2026
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r3.xyz = /* saturate */(r2.yyy * c_self_illumination_color.xyz + v1.xyz); r3.xyz = max(r3.xyz, 0);
  ...
  r0.xyz = /* saturate */(r0.xyz * r1.xyz + r2.xyz); r0.xyz = max(r0.xyz, 0);
