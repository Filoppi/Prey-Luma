  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r1.w = v2.w * r2.x;
  r2.xyw = Texture3.Sample(TexSampler3_s, v6.xyz).xyz;
  r2.xyw = v2.xyz * r2.xyw;
  r2.xyw = r2.xyw * r1.www;
  r0.xyz = /* saturate */(r0.xyz * r1.xyz + r2.xyw); r0.xyz = max(r0.xyz, 0);
  o0.w = r0.w; o0.w = saturate(o0.w);
  r1.xyz = Texture1.Sample(TexSampler1_s, v4.xy).xyz;
  r1.xyz = float3(-0.5,-0.5,-0.5) + r1.xyz;
  r1.xyz = r2.zzz * r1.xyz + float3(0.5,0.5,0.5);
  ...
  r1.xyz = /* saturate */(-v1.www * c_fog_color_correction_E.xyz + c_fog_color_correction_1.xyz); max(r1.xyz, 0);
