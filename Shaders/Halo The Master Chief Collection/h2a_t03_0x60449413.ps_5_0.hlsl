// ---- Created with 3Dmigoto v1.3.16 on Wed Aug 12 22:16:34 2026
...
Texture3D<float4> PS_TEXTURES_3D_0_ : register(t76);
  ...
  out float4 o0 : SV_Target0)
{
  ...
  TexTuple l = { PS_TEXTURES_3D_0_, PS_SAMPLERS_4__s };
  CalcPeakDeltaByLut(l);
...
//   r0.xyz = saturate(PS_REG_COMMON_HDR_PARAMS.zzz * r0.xyz);
  Rolloff();

  // r0.xyz = r0.xyz * float3(0.9375,0.9375,0.9375) + float3(0.03125,0.03125,0.03125);
  // r0.xyz = PS_TEXTURES_3D_0_.Sample(PS_SAMPLERS_4__s, r0.xyz).xyz;
  LUT(l);
