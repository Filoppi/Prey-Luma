// ---- Created with 3Dmigoto v1.3.16 on Sun Jul 12 20:10:32 2026
...
cbuffer _Globals : register(b0)
{
  ...
  float k_fBloomScale : packoffset(c22) = {1};
  float k_fExposure : packoffset(c22.y) = {1};
}
...
Texture2D<float3> tSourceBuffer : register(t0);
Buffer<float> ExposureBuffer : register(t1);
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.x = ExposureBuffer.Load(0).x;
  r0.yz = v1.xy / v1.ww;
  r0.yzw = tSourceBuffer.Sample(sPoint_CLAMPCLAMPCLAMP_Sampler_s, r0.yz).xyz;
  r1.xyz = r0.yzw * r0.xxx;

  r0.x = dot(r0.yzw, k_vHDRLuminanceWeights.xyz);
  o0.w = k_fBloomScale * r0.x;
  o0.w = saturate(o0.w);

  // o0.xyz = HejlDawson(r1.xyz);
  o0.xyz = HejlDawsonHDR(r1.xyz);
  o0.xyz = max(o0.xyz, 0);
  return;
}