// ---- Created with 3Dmigoto v1.3.16 on Tue Jun 23 00:13:27 2026
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.zw = t3.Sample(s2_s, v1.xy).xy; //refract map?
  r1.x = saturate(r0.x + r0.z);
  r1.x = cmp(r1.x < 0.00999999978);
  if (r1.x != 0) discard;
  r1.xyz = t2.Sample(s0_s, v1.xy).xyz; //normal map
  ...
  r2.xyz = t6.Sample(s5_s, r0.yw).xyz; r2.xyz = max(0, r2.xyz); r2.xyz = Reinhard::ReinhardSimple(r2.xyz); //color, rolled but no lut
  r0.xyw = r2.xyz * r0.xxx; r0.xyw = max(0, r0.xyw); 
  o0.xyz = r1.xyz * r0.zzz + r0.xyw; o0.xyz = max(0, o0.xyz);
  return;
}