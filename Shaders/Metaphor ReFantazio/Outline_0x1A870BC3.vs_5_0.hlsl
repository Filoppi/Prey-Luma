	...
	out float4 o9 : TEXCOORD3)
{
	...
	r0.x = dot(v3.xyz, mtxLocalToWorld._m00_m10_m20);
	r0.y = dot(v3.xyz, mtxLocalToWorld._m01_m11_m21);
	r0.z = dot(v3.xyz, mtxLocalToWorld._m02_m12_m22);
	...
	float3 prevNormal = v3.xyz;
	GetPreviousVertexParameters(vertexID, 20, prevPosition, prevNormal);
