	...
	out float4 o6 : TEXCOORD3)
{
	...
	o6.x = dot(r1.xyzw, mtxLocalToWorldViewProjPrev._m00_m10_m20_m30);
	o6.y = dot(r1.xyzw, mtxLocalToWorldViewProjPrev._m01_m11_m21_m31);
	o6.z = dot(r1.xyzw, mtxLocalToWorldViewProjPrev._m02_m12_m22_m32);
	o6.w = dot(r1.xyzw, mtxLocalToWorldViewProjPrev._m03_m13_m23_m33);
