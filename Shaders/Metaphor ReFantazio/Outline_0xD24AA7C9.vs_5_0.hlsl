	...
	out float4 o8 : TEXCOORD3)
{
	...
	r0.x = r0.x * r0.x;
	o5.w = -r0.y * r0.x + 1;
	o8.x = dot(r1.xyzw, mtxLocalToWorldViewProjPrev._m00_m10_m20_m30);
	o8.y = dot(r1.xyzw, mtxLocalToWorldViewProjPrev._m01_m11_m21_m31);
	o8.z = dot(r1.xyzw, mtxLocalToWorldViewProjPrev._m02_m12_m22_m32);
	o8.w = dot(r1.xyzw, mtxLocalToWorldViewProjPrev._m03_m13_m23_m33);
