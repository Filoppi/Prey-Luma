	...
	out float4 o5 : SV_Target5)
{
	...
	r0.z = max(0, r4.x);
	r0.z = r0.z * 0.5 + 0.5;
	r1.yzw = waterDeepColor.xyz * r0.zzz;
	r2.xyw = max(float3(9.99999975e-06,9.99999975e-06,9.99999975e-06), abs(r2.xyw));
	r0.z = dot(r2.xyw, r2.xyw);
	r0.z = rsqrt(r0.z);
	r5.xyz = r2.xyw * r0.zzz;
	r2.x = r5.x + r5.y;
	r0.z = r2.w * r0.z + r2.x;
	r2.xyw = r5.xyz / r0.zzz;
	r4.xw = texAnimationSpeed * TexShift.xy;
	r5.xyzw = v3.yzxz * triPlanarScale + r4.xwxw;
	r0.z = baseTexture.Sample(linearWrapSampler_s, r5.xy).x;
	r3.w = baseTexture.Sample(linearWrapSampler_s, r5.zw).x;
	...
	r2.xyw = -v2.xyz + r6.xyz;
	r2.x = dot(r2.xyw, r2.xyw);
	r2.x = sqrt(r2.x);
	r2.y = saturate(r2.x / OceanDepthScale);
	r2.w = DisturbanceDepthScale * r2.y;
	r3.yw = r4.yz * r2.ww;
	r2.z = invProjParams.z + r2.z;
	r2.z = invProjParams.w / r2.z;
	r4.xy = r4.yz * r2.ww + r3.xz;
	r2.w = depthTexture.Sample(pointWrapSampler_s, r4.xy).x;
	r2.w = r2.z >= r2.w;
	r2.w = r2.w ? 1.000000 : 0;
	r3.xy = r3.yw * r2.ww + r3.xz;
	r3.xyz = compositeTexture.Sample(pointWrapSampler_s, r3.xy).xyz;
	r1.yzw = r1.yzw * r0.zzz + -r3.xyz;
	r1.yzw = r2.yyy * r1.yzw + r3.xyz;
	r0.z = r1.x * r0.y;
	r0.z = waterReflectionColor.w * r0.z;
	r3.xyz = waterReflectionColor.xyz + -r1.yzw;
	r1.xyz = r0.zzz * r3.xyz + r1.yzw;
	r0.x = r0.x * r0.y;
	r0.xyz = r0.xxx * float3(0.5,0.5,0.5) + r1.xyz;
	r0.xyz = waterScatterColor.xyz * r0.www + r0.xyz;
	r0.w = r5.z < r2.z;
	if (r0.w != 0) {
		r0.w = r2.x / FoamDistance;
		r0.w = min(1, r0.w);
		r0.w = 1 + -r0.w;
		r1.y = cos(v4.x);
		r1.xw = float2(0.100000001,0.100000001) * TexShift.xy;
		r1.xy = v4.xy + -r1.xy;
		r1.x = foamTexture.Sample(linearWrapSampler_s, r1.xy).x;
		r1.z = sin(v4.y);
		r1.yz = v4.xy * float2(0.5,0.5) + r1.zw;
		r1.y = foamTexture.Sample(linearWrapSampler_s, r1.yz).z;
		r1.x = r1.x + r1.y;
	...
	r1.y = rsqrt(r0.w);
	r0.w = r1.y * r0.w;
	r0.w = r0.w * fogDistanceParameter.z + fogDistanceParameter.y;
	r0.w = saturate(-1 + r0.w);
	r0.w = 1 + -r0.w;
	r0.w = fogDistanceColor.w * r0.w;
	r2.xyz = fogDistanceColor.xyz + -r0.xyz;
