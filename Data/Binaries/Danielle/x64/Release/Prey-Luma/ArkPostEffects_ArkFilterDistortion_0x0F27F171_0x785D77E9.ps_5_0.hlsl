...
#if _RT_SAMPLE0
	{
		//TODOFT4: this permutations stretches a little bit too much in ultrawide? test whenever you get it happening (with gravity bombs?). Also test in general how does this shader react to non default FOVs
