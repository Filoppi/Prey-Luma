// ---- Created with 3Dmigoto v1.3.16 on Thu Jun 27 00:11:47 2024
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.xy = -r0.xy * cBlurFilterSize.ww + float2(1,1);
  r0.xy = saturate(-r0.yx * float2(0.5,0.5) + r0.xy);
  r2.xyzw = cBlurFilterColor2.xyzw * r0.yyyy;
  r2.xyzw = cBlurFilterColor1.xyzw * r0.xxxx + r2.xyzw;
  r0.x = 1 + -r0.x;
  r0.x = r0.x + -r0.y;
