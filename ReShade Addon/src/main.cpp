...
constexpr uint32_t MAX_SHADER_DEFINES = 20;
          ...
          for (auto shader_hash : shader_hashes_PostAA) {
              if (std::find(original_shader_hashes.begin(), original_shader_hashes.end(), shader_hash) != original_shader_hashes.end()) {
                  ...
                  if (dlss_inputs_valid) {
                      ...
                      std::array<unsigned int, 2> dlss_render_resolution = FindClosestIntegerResolutionForAspectRatio((double)output_texture_desc.Width * (double)dlss_sr_render_resolution, (double)output_texture_desc.Height * (double)dlss_sr_render_resolution, (double)output_texture_desc.Width / (double)output_texture_desc.Height);
                      ...
                      if (!skip_dlss) {
                          ...
                          // Restore the render targeting, hoping that if DLSS failed, it didn't already start changing cbuffers or texture resources bindings or viewport etc.
                          else
                          {
...
void Init() {
  ...
  }
  {
    ...
    strncpy(defines_text[i++], "1", MAX_SHADER_DEFINES_TEXT_LENGTH);
    strncpy(defines_text[i++], "ENABLE_LUT_EXTRAPOLATION", MAX_SHADER_DEFINES_TEXT_LENGTH);
    strncpy(defines_text[i++], "1", MAX_SHADER_DEFINES_TEXT_LENGTH);
    strncpy(defines_text[i++], "TONEMAP_TYPE", MAX_SHADER_DEFINES_TEXT_LENGTH);
    strncpy(defines_text[i++], "1", MAX_SHADER_DEFINES_TEXT_LENGTH);
    strncpy(defines_text[i++], "SUNSHAFTS_LOOK_TYPE", MAX_SHADER_DEFINES_TEXT_LENGTH);
    strncpy(defines_text[i++], "2", MAX_SHADER_DEFINES_TEXT_LENGTH);
    strncpy(defines_text[i++], "ENABLE_LENS_OPTICS_HDR", MAX_SHADER_DEFINES_TEXT_LENGTH);
    strncpy(defines_text[i++], "1", MAX_SHADER_DEFINES_TEXT_LENGTH);
    strncpy(defines_text[i++], "AUTO_HDR_VIDEOS", MAX_SHADER_DEFINES_TEXT_LENGTH);
    strncpy(defines_text[i++], "1", MAX_SHADER_DEFINES_TEXT_LENGTH);
    strncpy(defines_text[i++], "SSAO_TYPE", MAX_SHADER_DEFINES_TEXT_LENGTH);
    strncpy(defines_text[i++], "0", MAX_SHADER_DEFINES_TEXT_LENGTH);
    strncpy(defines_text[i++], "FORCE_NEUTRAL_COLOR_GRADING_LUT_TYPE", MAX_SHADER_DEFINES_TEXT_LENGTH);
    strncpy(defines_text[i++], "0", MAX_SHADER_DEFINES_TEXT_LENGTH);
    strncpy(defines_text[i++], "DRAW_LUT", MAX_SHADER_DEFINES_TEXT_LENGTH);
    strncpy(defines_text[i++], "0", MAX_SHADER_DEFINES_TEXT_LENGTH);
    strncpy(defines_text[i++], "FORCE_MOTION_VECTORS_JITTERED", MAX_SHADER_DEFINES_TEXT_LENGTH);
    strncpy(defines_text[i++], prey_taa_jittered ? "1" : "0", MAX_SHADER_DEFINES_TEXT_LENGTH);
    strncpy(defines_text[i++], "ENABLE_CAMERA_MOTION_BLUR", MAX_SHADER_DEFINES_TEXT_LENGTH);
    strncpy(defines_text[i++], "0", MAX_SHADER_DEFINES_TEXT_LENGTH);
