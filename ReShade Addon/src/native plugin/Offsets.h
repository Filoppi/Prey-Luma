...
public:
	...
	static constexpr std::array<uintptr_t, static_cast<uint8_t>(GameVersion::COUNT)> CD3D9Renderer_RT_RenderScene = { 0xF41CA0, 0xF64F40, 0xF0A2A0, 0xF2F0D0 };
	static constexpr std::array<uintptr_t, static_cast<uint8_t>(GameVersion::COUNT)> CD3D9Renderer_RT_RenderScene_Jitters = { 0x57A, 0x585, 0x5DC, 0x5E5 };
